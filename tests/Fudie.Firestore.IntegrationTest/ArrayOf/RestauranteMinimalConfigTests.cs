...
///
/// REQUIERE CONFIG:
/// - CASO 4: Certificacion.Certificador → Reference() (navegación dentro de ComplexType)
...
public class RestauranteMinimalConfigTests
{
    ...
    public async Task Caso1_ArrayOfEmbedded_AutoDetected_ShouldPersistAsArrayOfMaps()
    {
        ...
        using var context = _fixture.CreateContext<RestauranteMinimalConfigDbContext>();
