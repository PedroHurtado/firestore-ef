...
| 26 | Count | ✅ | `ddd6dc7` | `AggregationTests` (3 tests) |
| 27 | Any | ✅ | `ddd6dc7` | `AggregationTests` (3 tests) |
| 28 | Sum | ✅ | `ddd6dc7` | `AggregationTests` (3 tests) |
...
| Generator | LINQ | Firestore | Soportado |
|-----------|------|-----------|-----------|
| StartsWith | `.StartsWith()` | Workaround >= < | ✅ |
